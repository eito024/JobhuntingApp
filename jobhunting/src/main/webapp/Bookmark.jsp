<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "java.util.ArrayList" import = "bookmark.BusinessListSearchRecordBean"
    import = "bookmark.BusinessListSearchInfoArray" %>
<html>
<head>
...
<div class="headerbutton">
  <a href="./equal/UserMypage.html"><span class="hedbtn">マイページ</span></a>      <!-- href内に遷移先を書く -->
  <a href="UserBusinessListReferenceServlet"><span class="hedbtn">企業一覧</span></a>        <!-- href内に遷移先を書く -->
</div>
<!-- モーダルエリアここから -->
      ...
      <!--  ここから-->
		<form action="BusinessListSearchServlet"method="get">
			...
			<div class="content">
				...
				<input type="radio"  name="order"  value="1">昇順
			</div>
			<div class="content">
...
<!-- ここまでヘッダー -->
<!-- ここから<nav>の中はページの内容 -->
<jsp:useBean id="BLSIA" class="bookmark.BusinessListSearchInfoArray" scope="session" />
<%
...
<dl class="ac">
	...
	<table>
            <tr>
                ...
                <th>削除</th>
                <td>
                	<FORM action="BookmarkDeleteServlet"method="get" onSubmit="return check()">
						<button type="submit" value=<%=record.getBusinessNumber() %> name="number">☆</button>
					</FORM>
                </td>
            </tr>
            <tr>
