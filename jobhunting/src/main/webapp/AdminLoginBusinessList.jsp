...
<!-- ここまでCSS -->
<script src="./equal/js/jquery-2.1.4.min.js"></script>
</head>
...
<div class="headerbutton">
  <a href="./equal/AdminMypage.html"><span class="hedbtn">マイページ</span></a>      <!-- href内に遷移先を書く -->
  <a href="JavaScript:function;"  id="openModal"><img src="./equal/絞り込み.png"   class="hedimg" alt="絞り込み:クリックすると絞り込み"  title="" width="50px" height="50px"></a> <!-- href内に遷移先を書く -->
</div>
<!-- モーダルエリアここから -->
<section id="modalArea" class="modalArea">
  ...
  <div class="modalWrapper">
    ...
    <!-- ポップアップの中身ここから -->
      <!--  ここから-->
		<form action="AdminBusinessListSearchServlet"method="get">
			<div class="content">
				<p>絞り込み</p>
			</div>
			<div class="content">
		...
		<form action="AdminBusinessListSearchFreewordServlet"method="get">
			<div class="content">
				<p>キーワード</p>
	...
	<div class="sen">
		<table>
            <tr>
                ...
                <th>削除</th>
                    <td>
                    	<form action="BusinessInfoDeleteListServlet" method="post"   onSubmit="return check()">
							<button type="submit" name="name" value="<%=record.getBusinessNumber()%>">削除</button>
                    	</form>
                    </td>
            	</tr>
            	<tr>
                	...
                	<th>変更</th>
                    <td>
                    	<form action="BusinessInfoChangeServlet" method="post">
							<button type="submit" class="ok" name="name" value="<%=record.getBusinessNumber()%>">変更</button>
                    	</form>
                    </td>
            	</tr>
            	<tr>
