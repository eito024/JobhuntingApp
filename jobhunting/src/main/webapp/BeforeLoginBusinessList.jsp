...
<div class="headerbutton">
  <a href="./ログイン機能/user_login.jsp"><span class="hedbtn">ログイン</span></a>        <!-- href内に遷移先を書く -->
  <a href="./LoginInfo.html"><span class="hedbtn">ブックマーク</span></a>    <!-- href内に遷移先を書く -->
