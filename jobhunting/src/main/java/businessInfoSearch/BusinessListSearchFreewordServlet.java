 ...
 */
@WebServlet("/BusinessListSearchFreewordServlet")
public class BusinessListSearchFreewordServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)  {
		...
		try {
			...
			getServletContext().getRequestDispatcher("/BeforeLoginBusinessList.jsp").forward(request,response);
